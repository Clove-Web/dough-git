...
globalStyle(`${readme} .md-alert > :first-child`, { marginTop: 0 });

globalStyle(`${readme} .md-alert > :last-child`, { marginBottom: 0 });

globalStyle(`${readme} .md-alert-title`, {
  display: "flex",
  alignItems: "center",
  gap: "0.4rem",
  margin: "0 0 0.5rem",
...
for (const [kind, color] of Object.entries(alertColor)) {
  globalStyle(`${readme} .md-alert-${kind}`, {
